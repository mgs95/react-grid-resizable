...
exports.ColsWrapper = function (props) {
    return react_1.default.createElement(ColsWrapperDiv, null, GridWrapper_1.GridWrapper(__assign(__assign({}, props), { direction: 'horizontal' })));
};
